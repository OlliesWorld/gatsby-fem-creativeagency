    ...
    return (
        <section className="flex flex-col-reverse lg:flex-row">
            <div className=" w-4/5 my-12  ml-4 lg:w-3/4 lg:ml-24 ">
                ...
                <Link to="/" className="bg-red font-extrabold text-white p-6">Learn More</Link>
            </div>
            <div>
                <StaticImage src="../images/assets/desktop/image-hero.jpg" alt="hero img" width={895}
                    ...
                    <StaticImage src="../images/assets/tablet/image-hero.jpg" alt="hero img" width={435}
                    height={600} className="hidden md:block lg:hidden " placeholder="blurred" layout="fixed"/>
                    <StaticImage src="../images/assets/mobile/image-hero.jpg" alt="hero img" width={375}
